...
string TurboQuasarRepeatFwdModel::ModelVersion() const
{
  return "$Id: fwdmodel_asl_turboquasar_repeat.cc,v 1.9 2016/06/24 13:35:59 zhao Exp $";
}

void TurboQuasarRepeatFwdModel::HardcodedInitialDists(MVNDist& prior, 
    MVNDist& posterior) const
{
    Tracer_Plus tr("TurboQuasarRepeatFwdModel::HardcodedInitialDists");
...
void TurboQuasarRepeatFwdModel::Evaluate(const ColumnVector& params, ColumnVector& result) const
{
  Tracer_Plus tr("TurboQuasarRepeatFwdModel::Evaluate");
...
TurboQuasarRepeatFwdModel::TurboQuasarRepeatFwdModel(ArgsType& args)
{
...
void TurboQuasarRepeatFwdModel::ModelUsage()
{ 
  cout << "To be added"
       << endl
    ;
...
void TurboQuasarRepeatFwdModel::DumpParameters(const ColumnVector& vec,
                                    const string& indent) const
{
    
}

void TurboQuasarRepeatFwdModel::NameParams(vector<string>& names) const
{
  names.clear();
...
void TurboQuasarRepeatFwdModel::SetupARD( const MVNDist& theta, MVNDist& thetaPrior, double& Fard)
{
  Tracer_Plus tr("TurboQuasarRepeatFwdModel::SetupARD");
...
void TurboQuasarRepeatFwdModel::UpdateARD(
        const MVNDist& theta,
        MVNDist& thetaPrior, double& Fard) const
{
  Tracer_Plus tr("TurboQuasarRepeatFwdModel::UpdateARD");
...
ColumnVector TurboQuasarRepeatFwdModel::kcblood_nodisp(const ColumnVector& tis, float deltblood, float taub, float T_1bin, float deltll,float T_1ll,int n_bolus,float delta_bolus) const {
  Tracer_Plus tr("TurboQuasarRepeatFwdModel:kcblood_nodisp");
...
ColumnVector TurboQuasarRepeatFwdModel::kcblood_gammadisp(const ColumnVector& tis, float deltblood, float taub, float T_1bin, float s, float p, float deltll,float T_1ll) const {
  Tracer_Plus tr("TurboQuasarRepeatFwdModel:kcblood_gammadisp");
  ColumnVector kcblood(tis.Nrows());
  kcblood=0.0;
  float T_1b;
...
ColumnVector TurboQuasarRepeatFwdModel::kcblood_gvf(const ColumnVector& tis, float deltblood, float taub, float T_1bin, float s, float p, float deltll,float T_1ll) const {
  Tracer_Plus tr("TurboQuasarRepeatFwdModel:kcblood_gvf");
  ColumnVector kcblood(tis.Nrows());
  kcblood=0.0;
  float T_1b;
...
ColumnVector TurboQuasarRepeatFwdModel::kcblood_gaussdisp(const ColumnVector& tis, float deltblood, float taub, float T_1bin, float sig1, float sig2, float deltll,float T_1ll) const {
  Tracer_Plus tr("TurboQuasarRepeatFwdModel:kcblood_normdisp");
  ColumnVector kcblood(tis.Nrows());
  kcblood=0.0;
  float T_1b;
...
//Tissue
ColumnVector TurboQuasarRepeatFwdModel::kctissue_nodisp(const ColumnVector& tis, float delttiss, float tau, float T_1bin, float T_1app, float deltll,float T_1ll,int n_bolus_total,float delta_bolus) const {
  Tracer_Plus tr("TurboQuasarRepeatFwdModel::kctissue_nodisp");
...
ColumnVector TurboQuasarRepeatFwdModel::kctissue_gammadisp(const ColumnVector& tis, float delttiss, float tau, float T_1bin, float T_1app, float s, float p, float deltll,float T_1ll) const {
  Tracer_Plus tr("TurboQuasarRepeatFwdModel::kctissue_gammadisp");
  ColumnVector kctissue(tis.Nrows());
  kctissue=0.0;
  float ti=0.0;
...
ColumnVector TurboQuasarRepeatFwdModel::kctissue_gvf(const ColumnVector& tis, float delttiss, float tau, float T_1bin, float T_1app, float s, float p, float deltll,float T_1ll) const {
  Tracer_Plus tr("TurboQuasarRepeatFwdModel::kctissue_gvf");
  ColumnVector kctissue(tis.Nrows());
  kctissue=0.0;
  float ti=0.0;
  float T_1b;
...
ColumnVector TurboQuasarRepeatFwdModel::kctissue_gaussdisp(const ColumnVector& tis, float delttiss, float tau, float T_1bin, float T_1app, float sig1, float sig2, float deltll,float T_1ll) const {
    Tracer_Plus tr("TurboQuasarRepeatFwdModel::kctissue_gaussdisp");
ColumnVector kctissue(tis.Nrows());
 kctissue=0.0;
 float ti=0.0;
 float T_1b;
...
float TurboQuasarRepeatFwdModel::icgf(float a, float x) const {
  Tracer_Plus tr("TurboQuasarRepeatFwdModel::icgf");
...
float TurboQuasarRepeatFwdModel::gvf(float t, float s, float p) const {
  Tracer_Plus tr("TurboQuasarRepeatFwdModel::gvf");
